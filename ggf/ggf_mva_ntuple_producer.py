...
if __name__ == '__main__':
  ...
  if args.baseline == 'tight':
    name_tag = 'ggf_mva'
    baseline_cut = '(trigger>0) & (pass_filter>0) & (y_id80>0) & (y_pt/lly_m>15./110) & (leplep_m>80) & (leplep_m<100) & (lly_m+leplep_m>185) & (lly_m>100) & (lly_m<180) & (njet<=1) & (nlep<=2) & (met<90)'
    train_cut =    '(trigger>0) & (pass_filter>0) & (y_id80>0) & (y_pt/lly_m>15./110) & (leplep_m>80) & (leplep_m<100) & (lly_m+leplep_m>185) & (lly_m>100) & (lly_m<180) & (njet<=1) & (nlep<=2) & (met<90) & (lly_m>120) & (lly_m<130)'
    decorr_cuts = [] # Used when producing decorr variables.
  else:
    name_tag = 'ggf_mva_hig19014'
    baseline_cut = '(trigger>0) & (pass_filter>0) & (y_pt/lly_m>15./110) & (leplep_m>50) & (lly_m+leplep_m>185) & (lly_m>100) & (lly_m<180)'
    train_cut =    '(trigger>0) & (pass_filter>0) & (y_pt/lly_m>15./110) & (leplep_m>50) & (lly_m+leplep_m>185) & (lly_m>100) & (lly_m<180)'
    decorr_cuts = [] # Used when producing decorr variables.
  ...
  get_decorr_func(f'ntuples/{name_tag}_ntuples.root', 'train_tree_baseline', 'lly_m', decorr_variables,'weightXyear', 'classID==0', decorr_func_filename)
  apply_decorr_func(decorr_variables, decorr_func_filename, decorr_defines, decorr_cuts,
