...
if __name__ == "__main__":
  ...
  if method_id == 0: 
    mva_name = 'xgboost_ggfvbf_tight_01j_higwindow_var11'
    weight_method = 1 # Weight signal and background equally
    ...
    bdt_settings = {'max_depth':4, 'learning_rate':0.1, 'n_estimators':500, 'min_child_weight':5, 'eval_metric':'logloss'}
    #bdt_settings = {'max_depth':4, 'learning_rate':0.1, 'n_estimators':500, 'min_child_weight':5, 'eval_metric':'log_loss', 'disable_default_eval_metrics':True, 'objective':'reg:logistic'}
    #bdt_settings = {'max_depth':4, 'learning_rate':0.1, 'n_estimators':500, 'min_child_weight':5}
    train_cut = '1'
  elif method_id == 1: 
    mva_name = 'xgboost_ggfvbf_tight_2j_higwindow_var21'
    weight_method = 1 # Weight signal and background equally
    train_tree_name = 'train_tree'
  ...
  print(train_weight_array[train_weight_array<0])
